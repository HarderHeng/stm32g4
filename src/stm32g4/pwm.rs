//! STM32G4 PWM implementation
//!
//! Concrete implementation of the PwmOutput trait for STM32G4 TIM1.
...
impl Stm32G4Pwm {
    ...
    pub fn new(
        tim1: Peri<'static, embassy_stm32::peripherals::TIM1>,
        pa8: Peri<'static, embassy_stm32::peripherals::PA8>,
        pc13: Peri<'static, embassy_stm32::peripherals::PC13>,
        pa9: Peri<'static, embassy_stm32::peripherals::PA9>,
        pa12: Peri<'static, embassy_stm32::peripherals::PA12>,
        pa10: Peri<'static, embassy_stm32::peripherals::PA10>,
        pb15: Peri<'static, embassy_stm32::peripherals::PB15>,
        pa11: Peri<'static, embassy_stm32::peripherals::PA11>,
    ) -> Self {
    ...
    /// Direct access to the underlying Embassy PWM (for interrupt config etc.).
...
impl PwmOutput for Stm32G4Pwm {
    ...
    fn set_adc_trigger(&mut self, ccr: u16) {
        self.pwm.set_duty(Channel::Ch4, ccr as u32);
    }
    ...
    fn enable_update_interrupt(&mut self) {
        self.enable_update_interrupt();
    }

    fn disable_update_interrupt(&mut self) {
        self.disable_update_interrupt();
    }
}
